...
INSERT INTO achievement (name, description, image_url) VALUES
                                                ('튜토리얼을 끝냈어요!', '첫 시작을 축하합니다! 프로필을 완성했어요.(마이페이지 프로필 설정 완료)', '/img/achievement/튜토리얼을 끝냈어요.png'),
                                                ('회사를 정해브렀어~', '목표 기업을 정해 진로에 한 발자국 다가갔어요.(첫 목표 기업 설정하기)', '/img/achievement/회사를 정해브렀어~.png'),
                                                ('\'J\'로 가는 길.', '처음으로 할 일을 완료했어요! 멋져요.(첫 todo 체크리스트 체크하기)', '/img/achievement/J로 가는 길.png'),
                                                ('목표를 포착했다!', '진로를 위해 목표를 설정했어요!(기업 내 첫 목표 생성하기)', '/img/achievement/목표를 포착했다.png'),
                                                ('\'J\'스러운 사람', '다양한 목표를 세워 전진 중! 3개의 목표 기업을 정했어요.(목표 기업 3개 설정하기)', '/img/achievement/J스러운 사람.png'),
                                                ('초보 개발자 두두등장', '첫 성장의 발판! 이제 시작이에요.(레벨 2 달성)', '/img/achievement/초보 개발자 두두등장.png'),
                                                ('성장 중입니다', '당신은 더 이상 초보가 아니에요.(레벨 5 달성)', '/img/achievement/성장 중입니다.png'),
                                                ('전설의 지원자', '궁극의 개발자 여정을 완수했습니다. 🎉(만렙 달성)', '/img/achievement/전설의 지원자.png'),
                                                ('7일의 기적', '대단해요! 일주일 동안 쉬지 않았군요.(회원가입 한지 7일 경과)', '/img/achievement/7일의 기적.png'),
                                                ('계속해서 도전 중!', '취업을 향한 열정이 느껴져요!(목표 기업 5개 설정하기)', '/img/achievement/계속해서 도전 중!.png'),
                                                ('정리왕 등장', '완벽주의자도 울고 갈 체크 마스터!(todo 체크리스트 5개 체크하기)', '/img/achievement/정리왕 등장.png'),
                                                ('꾸준함의 상징', '진정한 노력가는 당신!(회원가입한지 30일 경과)', '/img/achievement/꾸준함의 상징.png'),
                                                ('몰아치기 장인', '놀라워요! 오늘 정말 열일했네요.(하루에 할 일 10개 완료)', '/img/achievement/몰아치기 장인.png'),
                                                ('알림 개시자', '알림 기능을 켰어요! 준비 완료~(알람 최초로 켜기)', '/img/achievement/알림개시자.png');
