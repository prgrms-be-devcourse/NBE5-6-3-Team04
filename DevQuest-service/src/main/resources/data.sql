...
INSERT INTO achievement (name, description, image_url) VALUES
                                                ('튜토리얼을 끝냈어요!', '첫 시작을 축하합니다! 프로필을 완성했어요. (마이페이지 프로필 설정하기)', '/img/achievement/튜토리얼을 끝냈어요.png'),
                                                ('회사를 정해브렀어~', '목표 기업을 정해 진로에 한 발자국 다가갔어요. (첫 목표 기업 설정하기)', '/img/achievement/회사를 정해브렀어~.png'),
                                                ('J로 가는 길.', '처음으로 할 일을 완료했어요! 멋져요. (첫 todo 체크리스트 체크하기)', '/img/achievement/J로 가는 길.png'),
                                                ('목표를 포착했다!', '진로를 위해 목표를 설정했어요! (기업 내 첫 목표 생성하기)', '/img/achievement/목표를 포착했다.png'),
                                                ('J스러운 사람', '다양한 목표를 세워 전진 중! 3개의 목표 기업을 정했어요. (목표 기업 3개 설정하기)', '/img/achievement/J스러운 사람.png'),
